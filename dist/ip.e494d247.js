...
function idCard(dividiv) {
  ...
  var infoIp = document.createElement("h3");
  var landNum = document.createElement("p");
  var locInfo = document.createElement("p");
  var cityName = document.createElement("p");
  var timeZone = document.createElement("p");
  var currencyUnit = document.createElement("p");
  var nIsp = document.createElement("p");
  ...
  locInfo.textContent = "Enlem: ".concat(dividiv["enlem"], " Boylam: ").concat(dividiv["boylam"]);
  cityName.textContent = "\u015Eehir: ".concat(dividiv["şehir"]);
  timeZone.textContent = "Saat dilimi: ".concat(dividiv["saatdilimi"]);
  currencyUnit.textContent = "Para birimi: ".concat(dividiv["parabirimi"]);
  nIsp.textContent = "ISP: ".concat(dividiv["isp"]);
...
var cardSpawn = document.querySelector("div.cards");
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          _axios.default.get("https://apis.ergineer.com/ipgeoapi/" + benimIP).then(function (response) {
            cardSpawn.appendChild(idCard(response.data));
